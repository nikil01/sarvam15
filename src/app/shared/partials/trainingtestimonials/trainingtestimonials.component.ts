...
@Component({
  selector: 'app-trainingtestimonials',
  standalone: true,
  imports: [CommonModule,SwiperDirectiveDirective],
  templateUrl: './trainingtestimonials.component.html',
  styleUrls: ['./trainingtestimonials.component.css'],
...
export class TrainingtestimonialsComponent {
     ...
     filepath:string=Constant.API_ENDPOINT+"site/";
		...
		public config: SwiperOptions = {
		  ...
		  getTestimonydata(){
		    this.api.getTestimonyTraining().subscribe(res => {     
