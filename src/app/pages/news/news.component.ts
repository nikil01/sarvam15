...
export class NewsComponent {
	filepathblog:string=Constant.API_ENDPOINT+"site/events/";
    eventData:any;
    eventList:any;
    ...
    constructor(private api: ApiService, private router: Router, private Activatedroute: ActivatedRoute, private calendar: NgbCalendar, public formatter: NgbDateParserFormatter, private metaService: Meta, private titleService: Title) {
	...
	FetchSEOdata(url:any){
	    this.api.fetchSeoData(url).subscribe((res) => {
	      ...
	      if(res.success){
	        ...
	        this.titleService.setTitle("Sarvam Safety Private Limited - News From Safety Industry and Sarvam safety");
	...
	pageData:any={};
    getPageData(){
      this.api.GetPageDataFacts('news').subscribe(res => {     
        // console.log(res.response);        
